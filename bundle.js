...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PageContent = __webpack_require__(255);
	...
	(0, _reactDom.render)(_react2.default.createElement(
	    ...
	    _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	            ...
	            _react2.default.createElement(_reactRouter.Route, { path: '/:key', component: _PageContent2.default })
	        )
	    )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SubmitButton = __webpack_require__(248);

	var _SubmitButton2 = _interopRequireDefault(_SubmitButton);

	var _actionCreator = __webpack_require__(249);
	...
	var App = _react2.default.createClass({
	    ...
	    componentDidMount: function componentDidMount() {
	        ...
	        this.basicData = _data.basicInitData;
	        this.contactData = _data.contactInitData;
	        this.loanData = _data.loanInitData;
	        this.pbasicData = _data.pbasicInitData;
	        // requestCar({
	        //     key:'carFactory',
	        //     val:null,
	    ...
	    render: function render() {
	        ...
	        var children = _react2.default.cloneElement(this.props.children, { contain: contain, onChange: function onChange(key, val) {
	        ...
	        return _react2.default.createElement(
	            'div',
	            null,
	            _react2.default.createElement(_Header2.default, { tabs: tabs, activeTab: activeTab,
	                onClick: function onClick(e, tabName) {
	                    console.log(e);
	                    if (tabName != activeTab) {
	                        switch (activeTab) {
	                            case 'basic':
	                                _this.basicData = contain;
	                                break;
	                            case 'loan':
	                                _this.loanData = contain;
	                                break;
	                            case 'pbasic':
	                                _this.pbasicData = contain;
	                                break;
	                            case 'contact':
	                                _this.contactData = contain;
	                                break;
	                        }
	                        var result = (0, _validate2.default)(contain);
	                        if (!result.pass) {
	                            alert(result.error);
	                            e.preventDefault();
	                            return;
	                        ...
	                        switch (tabName) {
	                            case 'basic':
	                                actions.changePageData(_this.basicData);
	                                break;
	                            case 'loan':
	                                actions.changePageData(_this.loanData);
	                                break;
	                            case 'pbasic':
	                                actions.changePageData(_this.pbasicData);
	                                break;
	                            case 'contact':
	                                actions.changePageData(_this.contactData);
	                                break;
	                        }
	                    }
	                } }),
	            children,
	            _react2.default.createElement(_SubmitButton2.default, { buttonText: buttonText,
	                onClick: function onClick() {
	                    var currentIndex = 0;
	                    tabs.map(function (tab, index) {
	                        if (tab.value == _this.activeTab) {
	                            currentIndex = index;
	                        }
	                    });
	...
	function mapDispatchToProps(dispatch) {
	    var actions = (0, _redux.bindActionCreators)(actionCreator, dispatch);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Tab = __webpack_require__(245);
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    this.props.tabs.map(function (tab, index) {
	                        return _react2.default.createElement(_Tab2.default, _extends({}, tab, { key: index, index: index, activeTab: _this2.props.activeTab, width: _this2.props.tabs.length == 4 ? '25%' : '33.3%',
	                            onClick: function onClick(e, tabName) {
	                                return _this2.props.onClick(e, tabName);
	                            } }));
	                    })
	                )
	            );
	        ...
	        value: function render() {
	            ...
	            if (this.props.value == 'loan') {
	                return _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        _NavLink2.default,
	                        { to: '/', onlyActiveOnIndex: true, onClick: function onClick(e) {
	                                return _this2.props.onClick(e, _this2.props.value);
	                            } },
	                        this.props.name
	                    )
	                );
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    _NavLink2.default,
	                    { to: '/' + this.props.value, onClick: function onClick(e) {
	                            return _this2.props.onClick(e, _this2.props.value);
	                        } },
	                    this.props.name
	                )
...
/***/ function(module, exports) {
	 ...
	 * Created by sunsu on 2016/9/19.
	 */
	var basicInitData = exports.basicInitData = [{ label: '姓名', type: 'input', _key: 'name', require: true, placeholder: '请输入姓名', rule: ['^\\d+$', function () {
	        return false;
	    }], error: ['不是数字', '测试函数返回false'] }, { label: '性别', type: 'select', _key: 'sex', require: true, options: [{ val: 'Male', text: '男' }, { val: 'Female', text: '女' }], value: 'Female' }, { label: '证件类型', type: 'select', _key: 'certType', require: true, options: [{ val: 1, text: '身份证' }, { val: 2, text: '军官证' }, { val: 3, text: '护照' }, { val: 4, text: '士兵证' }], value: 1 }, { label: '证件号码', type: 'input', _key: 'certNo', require: true, placeholder: '请输入证件号码' }, { label: '婚姻状况', type: 'select', _key: 'marriageStatus', require: true, options: [{ val: 'Single', text: '未婚' }, { val: 'Married', text: '已婚' }], value: 'Single' }, { label: '出生日期', type: 'input', _key: 'birthday', require: true }, { label: '学历', type: 'select', _key: 'education', require: true,
	    options: [{ val: '', text: '请选择' }, { val: 'Doctor', text: '博士' }, { val: 'Master', text: '研究生' }, { val: 'Bachelor', text: '大学本科' }], value: '' }, { label: '职业', type: 'select', _key: 'jobIndustry', require: true,
	    options: [{ val: '', text: '请选择' }, { val: 'GovernmentEmployee', text: '国家机关、党群组织、企业、事业单位负责人' }, { val: 'Technician', text: '专业技术人员' }, { val: 'Clerk', text: '办事人员和有关人员' }], value: '' }, { label: '工作单位', type: 'input', _key: 'jobCompany', require: true }, { label: '申请人职务', type: 'select', _key: 'jobPosition', require: true,
	    options: [{ val: '', text: '请选择' }, { val: 'Seniormanager', text: '高级领导-局级及局级以上或高管人员' }, { val: 'Manage', text: '一般员工' }, { val: 'Other', text: '其他' }], value: '' }];

	var contactInitData = exports.contactInitData = [{ label: '户籍所在地地址', type: 'input', _key: 'PROVINCE_CITY', require: true }];

	var loanInitData = exports.loanInitData = [{ label: '是否有驾驶证', type: 'select', _key: 'drivingLicenseHas', require: true,
	    options: [{ val: 'Has', text: '有' }, { val: 'No', text: '无' }, { val: 'Training', text: '学车' }, { val: 'HireDriver', text: '雇佣司机' }, { val: 'Other', text: '其他' }], value: 'Has' }, { label: '制造商', type: 'select', _key: 'carFactory', require: true, options: [{ val: '', text: '请选择' }, { val: 'vfs', text: '上汽大众' }], value: '' }];
	var pbasicInitData = exports.pbasicInitData = [{ label: '配偶姓名', type: 'input', _key: 'p_name', require: true }];

	var VisibleFilters = exports.VisibleFilters = {
	    BASIC: 'basic',
	    PBASIC: 'pbasic',
	    CONTACT: 'contact',
	    LOAN: 'loan'
	    ...
	    _createClass(SubmitButton, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    "div",
	                    { className: "submit_btn", onClick: function onClick() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.changeHeaderTab = changeHeaderTab;
	exports.changePageButtonText = changePageButtonText;
	exports.changePageData = changePageData;
	exports.changeCurrentPageData = changeCurrentPageData;
	exports.requestCar = requestCar;
	exports.validate = validate;

	var _action = __webpack_require__(250);

	var _isomorphicFetch = __webpack_require__(252);
	 ...
	 * Created by sunsu on 2016/9/20.
	 */
	function changeHeaderTab(activeTab) {
	    return function (dispatch) {
	        return dispatch((0, _action.changeTab)(activeTab));
	    };
	}
	function changePageButtonText(tabs, activeTab) {
	    console.log(activeTab, tabs[tabs.length - 1].value);
	    if (activeTab == tabs[tabs.length - 1].value) {
	        return function (dispatch) {
	            return dispatch((0, _action.changeButtonText)('提交'));
	        };
	    }
	    return function (dispatch) {
	        return dispatch((0, _action.changeButtonText)('下一步'));
	    };
	}

	function changePageData(data) {
	    return function (dispatch) {
	        return dispatch((0, _action.changePageContent)(data));
	    };
	}
	function changeCurrentPageData(key, val) {
	    return function (dispatch) {
	        return dispatch((0, _action.changeCurrentPageContent)(key, val));
	    };
	}
	function requestCar(params) {
	    return function (dispatch) {
	        (0, _isomorphicFetch2.default)(params.base + 'unit/carModels/' + params.type + '/' + params.parent, {
	            headers: {
	            ...
	            console.log(list);
	            dispatch((0, _action.changeCurrentPageContent)(params.key, params.val, list));
	        });
	    };
	}
	...
	function validate(validateData) {
	    return function (dispatch) {
	        return dispatch((0, _action.validateInput)(validateData));
	    };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.changeButtonText = changeButtonText;
	exports.changeCurrentPageContent = changeCurrentPageContent;
	exports.changePageContent = changePageContent;
	exports.validateInput = validateInput;

	var _actionType = __webpack_require__(251);

	var CHANGE_TAB = _actionType.type.CHANGE_TAB; /**
	                                               * Created by sunsu on 2016/9/20.
	                                               */

	var CHANGE_BUTTON_TEXT = _actionType.type.CHANGE_BUTTON_TEXT;
	var CHANGE_PAGE_CONTENT = _actionType.type.CHANGE_PAGE_CONTENT;
	var CHANGE_CURRENT_PAGE_CONTENT = _actionType.type.CHANGE_CURRENT_PAGE_CONTENT;
	var VALIDATE = _actionType.type.VALIDATE;
	...
	function changeCurrentPageContent(key, val, list) {
	    switch (key) {
	        case 'drivingLicenseHas':
	            return {
	                ...
	                data: val == 'Other' || val == 'HireDriver' ? {
	                    index: 1,
	                    items: [{ label: '代驾人姓名', type: 'input', _key: 'designaterName', require: true, placeholder: '请输入代驾人姓名' }, { label: '代驾人驾驶证号', type: 'input', _key: 'designaterIDNo', require: true, placeholder: '请输入代驾人驾驶证号' }],
	                    key: key,
	                    val: val
	                } : {
	                    index: 1,
	...
	function validateInput(validateData) {
	    return {
	        type: VALIDATE,
...
/***/ function(module, exports) {
	...
	var type = exports.type = {
	    ...
	    CHANGE_TABS_LIST: 'CHANGE_TABS_LIST',
	    CHANGE_BUTTON_TEXT: 'CHANGE_BUTTON_TEXT',
	    CHANGE_PAGE_CONTENT: 'CHANGE_PAGE_CONTENT', //切换tab时改变整个页面数据
	    CHANGE_CURRENT_PAGE_CONTENT: 'CHANGE_CURRENT_PAGE_CONTENT', //控制当前页面的某些内容的显示或隐藏，即改变添加或删除state.data的元素
	    VALIDATE: 'VALIDATE'
	};
...
/***/ function(module, exports) {
	...
	function validate(data) {
	    ...
	    for (var i = 0, length = data.length; i < length; i++) {
	        ...
	        if (item.rule) {
	            for (var index = 0, len = item.rule.length; index < len; index++) {
	                var element = item.rule[index];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PageContent = function (_Component) {
	    ...
	    _createClass(PageContent, [{
	        key: '__getSource',
	        value: function __getSource(key) {
	            console.log(key);
	            switch (key) {
	                case 'basic':
	                    return _data.basicInitData;
	                case 'contact':
	                    return _data.contactInitData;
	                case 'pbasic':
	                    return _data.pbasicInitData;
	                case 'loan':
	                default:
	                    return _data.loanInitData;
	            }
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            var __handleChange = this.props.onChange;
	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement(
	                    ...
	                    this.props.contain.map(function (item, index) {
	                        return _react2.default.createElement(_List2.default, _extends({}, item, { key: index, onChange: function onChange(key, val) {
	                                return __handleChange(key, val);
	                            } }));
	                    })
	                ),
	                _react2.default.createElement(
	...
	var List = _react2.default.createClass({
	    ...
	    render: function render() {
	        ...
	        return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                'div',
	                { className: 'label' },
	                this.props.label + (this.state.showCount ? this.state.myCount : ''),
	                this.props.require ? _react2.default.createElement(
	                    'span',
	                    { className: 'required' },
	                    '*'
	                ) : ''
	            ...
	            _react2.default.createElement(
	                'div',
	                { className: 'input' },
	                this.props.type == 'input' ? _react2.default.createElement('input', { type: 'text', placeholder: this.props.placeholder, ref: this.props._key, value: this.props.value, onChange: function onChange() {
	                        console.log(_this.props._key, _this.refs[_this.props._key].value);_this.props.onChange(_this.props._key, _this.refs[_this.props._key].value);
	                    } }) : _react2.default.createElement(
	                    'select',
	                    { ref: this.props._key, value: this.props.value, onChange: function onChange() {
	                            console.log(_this.props._key, _this.refs[_this.props._key].value);_this.props.onChange(_this.props._key, _this.refs[_this.props._key].value);
	                        } },
	                    this.props.options.map(function (element) {
	                        if (element.val) {
	                            return _react2.default.createElement(
	                                'option',
	                                { key: element.val, value: element.val },
	                                element.text
	                            );
	                        } else {
	                            return _react2.default.createElement(
	                                'option',
	                                { key: element.val, value: element.val, disabled: true, style: { display: 'none' } },
	                                element.text
	                            );
	                        }
	                    })
	    ...
	    componentDidMount: function componentDidMount() {
	        ...
	        if (this.state.myCount == 0) {
	            ...
	            var orgLabel = node.children[0].innerHTML;
	            node.children[0].innerHTML = orgLabel + 2;
	        }
	        if (this.state.myCount == 1) {
	            var _node = document.getElementsByClassName('label')[1];
	            var _orgLabel = _node.children[1].innerHTML;
	            _node.children[0].innerHTML = _orgLabel + 3;
	        }
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function configureStore() {
	    return createStoreWithMiddleware(_reducer2.default);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _changTabReducer = __webpack_require__(261);

	var _changTabReducer2 = _interopRequireDefault(_changTabReducer);

	var _changeTabsListReducer = __webpack_require__(262);

	var _changeTabsListReducer2 = _interopRequireDefault(_changeTabsListReducer);

	var _changeButtonTextReducer = __webpack_require__(263);

	var _changeButtonTextReducer2 = _interopRequireDefault(_changeButtonTextReducer);

	var _changePageDataReducer = __webpack_require__(264);

	var _changePageDataReducer2 = _interopRequireDefault(_changePageDataReducer);

	var _validateReducer = __webpack_require__(266);
	...
	var reducer = (0, _redux.combineReducers)({
	    activeTab: _changTabReducer2.default,
	    tabs: _changeTabsListReducer2.default,
	    buttonText: _changeButtonTextReducer2.default,
	    data: _changePageDataReducer2.default,
	    validate: _validateReducer2.default
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function data() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? 'loan' : arguments[0];
	    var action = arguments[1];

	    switch (action.type) {
	        case _actionType.type.CHANGE_TAB:
...
/***/ function(module, exports, __webpack_require__) {
	...
	function data() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? [{ value: 'loan', name: '贷款信息' }, { value: 'basic', name: '基本信息' }, { value: 'contact', name: '联系方式' }] : arguments[0];
	    var action = arguments[1];

	    switch (action.type) {
	        case _actionType.type.CHANGE_TABS_LIST:
...
/***/ function(module, exports, __webpack_require__) {
	...
	function data() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? '下一步' : arguments[0];
	    var action = arguments[1];

	    switch (action.type) {
	        case _actionType.type.CHANGE_BUTTON_TEXT:
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _data2 = __webpack_require__(247);

	var _deepClone = __webpack_require__(265);
	...
	function data() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? _data2.loanInitData : arguments[0];
	    var action = arguments[1];

	    switch (action.type) {
	        case _actionType.type.CHANGE_PAGE_CONTENT:
	            return action.data;
	        case _actionType.type.CHANGE_CURRENT_PAGE_CONTENT:
	            var result = (0, _deepClone2.default)(state);
	                ...
	                case 'drivingLicenseHas':
	                    if (!action.data.length) {
	                        if (JSON.stringify(result).indexOf(action.data.items[0]._key) == -1) {
	                            var preData = result.slice(0, action.data.index),
	                                nextData = result.slice(action.data.index);
	                            return preData.concat(action.data.items).concat(nextData);
	                        } else return result;
	                    } else {
	                        if (JSON.stringify(result).indexOf(action.data.items[0]._key) != -1) {
	                            var _data = result.slice();
	                            _data.splice(action.data.index, action.data.length);
	                            return _data;
	                        }
	                        return result;
	                    }
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	function data() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? { pass: false, error: '制造商是必填项' } : arguments[0];
	    var action = arguments[1];

	    switch (action.type) {
	        case _actionType.type.VALIDATE:
	            var result = {};
	            for (var i = 0, length = action.validateData.length; i < length; i++) {
	                var item = action.validateData[i];
	                if (item.require && !item.value) {
	                    result.pass = false;
	                    result.error = item.label + '是必填项';
	                    break;
